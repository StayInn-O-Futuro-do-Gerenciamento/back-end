...
export class InitialMigration1699446724965 implements MigrationInterface {
    name = 'InitialMigration1699446724965'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "typeRomm" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(80) NOT NULL, "description" text NOT NULL, "confort" text NOT NULL, "price" numeric NOT NULL, "personCount" integer NOT NULL, "rate" "public"."typeRomm_rate_enum" NOT NULL DEFAULT 'Flexível', "offerId" uuid, CONSTRAINT "PK_67ff5fc4d7991fe0888dc882323" PRIMARY KEY ("id"))`);

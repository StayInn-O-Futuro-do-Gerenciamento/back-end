...
export class Mrigrations1701085413172 implements MigrationInterface {
    name = 'Mrigrations1701085413172'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "room" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "roomNumber" character varying NOT NULL, "status" "public"."room_status_enum" NOT NULL DEFAULT 'Limpo', "secretKey" character varying(20) NOT NULL, "floor" character varying NOT NULL, "available" boolean NOT NULL DEFAULT true, "hotelId" uuid, "typeRoomId" uuid, CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" character varying(100) NOT NULL, "number" character varying(10) NOT NULL, "city" character varying(50) NOT NULL, "state" character varying(50) NOT NULL, "zipCode" character varying(10) NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "wppConnect" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "instanceName" character varying NOT NULL, "token" character varying NOT NULL, "managerId" uuid, CONSTRAINT "REL_d37f890a4e6f6cdef16a1463f2" UNIQUE ("managerId"), CONSTRAINT "PK_fe488e2278e7f701d0c650f81a3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "wppConnect" ADD CONSTRAINT "FK_d37f890a4e6f6cdef16a1463f2f" FOREIGN KEY ("managerId") REFERENCES "manager"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "wppConnect" DROP CONSTRAINT "FK_d37f890a4e6f6cdef16a1463f2f"`);
        ...
        await queryRunner.query(`DROP TABLE "wppConnect"`);
